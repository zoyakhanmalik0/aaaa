...
>
  ...
  <div
    style={{
      ...
      height: "100%",
      borderRadius: "50%",
      background: "rgba(239,68,68,0.4)",   // solid red fill
      filter: "blur(60px) brightness(0.5)", // stronger glow
      boxShadow: "0 0 20px 20px #ef4444",  // wide glow effect
    }}
  />
</div>
            ...
            <RotatingText 
              ...
              fontSize="clamp(2.7rem, 4.5vw, 5rem)"
     ...
     style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}> */}
      ...
      <section className="relative min-h-screen overflow-hidden py-10 sm:py-16 lg:py-20 bg-black overflow-x-hidden">
        ...
        <div className="container relative mx-auto z-20 px-4 lg:px-6">
          ...
          <div className="absolute bottom-20 -right-55 -z-10 hidden pointer-events-none select-none lg:block">
  <img
  ...
  />
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
            <div>
              ...
              <h2
                data-aos="fade-up"
                className="text-3xl sm:text-4xl lg:text-5xl text-white font-light !leading-normal"
              >
                Join our <span className="text-red-500 font-semibold">agency</span> of creative innovators
              </h2>
            </div>
            <div className="lg:text-lg text-white lg:pt-0">
              <p className="text-white text-lg lg:text-xl leading-relaxed">Join our creative community to collaborate, innovate, and thrive together. We welcome passionate individuals eager to make an impact.</p>
            </div>
          </div>
        ...
        {/* ✅ Content */}
        <div className="container mx-auto px-4 lg:px-6 relative z-20 mt-32">
          <div className="relative mx-auto z-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              ...
              <div data-aos="fade-right" className="h-fit self-start text-center lg:text-start">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white !leading-normal font-light">
                  Innovative <span className="text-red-500 font-semibold">features</span>
                </h2>
                <p className="text-xl md:text-2xl lg:text-3xl text-white mb-6 sm:mb-8">
