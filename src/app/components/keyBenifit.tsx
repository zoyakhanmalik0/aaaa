...
const benefitsData = [
  {
    ...
    description:
      "Tailored solutions customized to fit your brand's unique needs and business goals.",
  },
  {
    id: "02",
    icon: (
    ...
    description:
      "Skilled professionals with deep industry knowledge delivering exceptional quality and innovative solutions.",
  },
  {
    id: "03",
    icon: (
    ...
    description:
      "Strategic insights backed by analytics to maximize ROI and ensure measurable success.",
  },
  {
    id: "04",
    icon: (
    ...
    description:
      "Continuous support and maintenance to ensure your digital solutions remain optimized and effective.",
  },
];
...
const BenefitsSection: React.FC = () => (
  <div className="relative bg-black text-gray-200 font-sans min-h-screen overflow-hidden px-4 sm:px-6 lg:px-8 pt-20 lg:pt-40">
