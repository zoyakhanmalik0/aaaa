...
export default function Page() {
  ...
  return (
    <div className="bg-black text-gray-200 min-h-screen font-sans relative overflow-hidden py-20 lg:py-40">
       {/* 🔴 Bottom Left Ring */}
<div
        ...
        <header className="mb-16">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="text-center lg:text-start">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-tight text-white mb-4">
                Insights on digital <span className="text-red-500 font-semibold">innovation</span>
              </h1>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-tight text-white">
                and <span className="text-red-500 font-semibold">growth</span>
              </h1>
            </div>
