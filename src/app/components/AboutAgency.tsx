...
const AboutAgencySection: React.FC = () => {
  const aboutItems = [
    ...
    },
    {
      ...
      description:
        "Driven by innovation and excellence, TechGuar reimagines digital possibilities. We build solutions that not only fulfill your vision but elevate your brand to the next level. Our focus is on creativity, performance, and long-term client success.",
    },
    {
