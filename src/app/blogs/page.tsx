...
export default function Blogs() {
  return (
    <div className="!w-full bg-cover bg-center bg-black relative overflow-hidden" style={{ backgroundImage: 'url(/media/bg.0f5970d1.png)' }}>
      ...
      {/* Hero Section */}
      <div className="w-full h-full flex items-center justify-center py-48 relative bg-cover bg-center overflow-hidden" style={{ backgroundImage: 'url(/media/Inner_bg.23beb686.jpg)' }}>
        {/* 🔴 Top Right Ring */}
        <div
        ...
        <div className="flex flex-col justify-center items-center gap-8 font-semibold text-center text-white relative z-10">
