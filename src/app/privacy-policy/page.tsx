        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                You can choose not to provide certain information, but this may limit the services we can offer. If you no longer wish to receive marketing communications from us, you can opt out by following the unsubscribe link in our emails or by contacting us at info@techguar.com.
              </p>
            </section>
            ...
            <section className="mb-6">
              ...
              <ul className="text-gray-300 mt-3 space-y-1">
                <li>Email: <a className="text-red-500 underline" href="mailto:info@techguar.com">info@techguar.com</a></li>
                <li>Phone Australia: <span className="">+61 3 6184 7156</span></li>
                <li>Phone Canada: <span className="">+1 365 601 4348</span></li>
                <li>Address: 402/9 Yarra Street, South Yarra, Victoria, Australia</li>
              </ul>
            </section>
