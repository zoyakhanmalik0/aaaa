...
export default function PricingPlan() {
  ...
  return (
    <div className="!w-full bg-black text-white pb-10">
      ...
      {/* Hero Section */}
      <div
        className="w-full h-full flex items-center justify-center py-48 relative bg-cover bg-center bg-no-repeat overflow-hidden"
        style={{ backgroundImage: 'url(/media/Inner_bg.23beb686.jpg)' }}
      >
        {/* 🔴 Top Left Ring */}
        <div
          className="absolute top-[-100px] left-[-200px] z-0 pointer-events-none"
        ...
        <div className="flex flex-col justify-center items-center gap-8 font-semibold text-white relative z-10">
